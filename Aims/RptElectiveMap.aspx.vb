...
Partial Class RptElectiveMap
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Dim ElecSubject As Integer = ddlElecSubj.SelectedValue
        ...
        Else
            Dim qrystring As String = "RptElectiveMapV.aspx?" & QueryStr.Querystring() & "&Batch=" & Batch & "&Semester=" & Semester & "&ElecSubject=" & ElecSubject
