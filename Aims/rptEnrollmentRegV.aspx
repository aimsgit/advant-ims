<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptEnrollmentRegV.aspx.vb" Inherits="rptEnrollmentRegV" %>
...
<head runat="server">
    <title>Final Examination Result Report</title>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
           <asp:Label ID="lblErrorMsg" runat="server" SkinID="lblRed" />
       </div>
    </form>
</body>
</html>
