Partial Class Mfg_rptPendingPO
    Inherits BasePage
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "Mfg_rptPendingPOV.aspx?" & QueryStr.Querystring() & "&SupplierId=" & SupplierId & "&StartDate=" & fromdate & "&EndDate=" & enddate
