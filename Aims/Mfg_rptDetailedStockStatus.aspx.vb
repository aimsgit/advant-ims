...
Partial Class Mfg_rptDetailedStockStatus
    Inherits BasePage
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "Mfg_rptDetailedStockStatusV.aspx?" & QueryStr.Querystring() & "&ProductId=" & ProductId & "&StartDate=" & fromdate & "&EndDate=" & enddate
