<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStudAttendWitElecSub.aspx.vb"
    Inherits="RptStudAttendWitElecSub" Title="Student Attendance" %>
...
<body style="width: 800px; height: 800px">
    ...
    <script type="text/javascript" language="javascript">
        function Valid() {
            var msg;
            msg = ValidateDateN(document.getElementById("<%=txtFromDateExt.ClientID%>"), 'From Date');
            if (msg != "") {
                document.getElementById("<%=txtFromDateExt.ClientID%>").focus();
                return msg;
            }
            msg = ValidateDateN(document.getElementById("<%=txtToDateExt.ClientID%>"), 'To Date');
            if (msg != "") {
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                <center>
                    <asp:Label ID="LabelStdAt" runat="server" Text="STUDENT ATTENDANCE" SkinID="lblRepRsz"
                ...
                <center>
                    ...
                    <table id="table1" class="custTable">
                        ...
                        <%-- <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="cmbAcademic" TabIndex="2" runat="server" SkinID="ddlRsz" AutoPostBack="True"
                                    DataValueField="id" DataTextField="AcademicYear" DataSourceID="ObjAcademic" Width="250">
                                </asp:DropDownList>
                            </td>
                        </tr>--%>
                        <tr>
                        ...
                        <%--<tr>
                            <td align="right">
                                <asp:Label ID="lblElecSub" runat="server" Text="Elective Subject :&nbsp;&nbsp;" SkinID="lblRsz"
                                    Width="150px"></asp:Label>
                            </td>
                            <td align="left">
                                <asp:DropDownList ID="ddlElecSub" TabIndex="5" runat="server" SkinID="ddlRsz" DataValueField="SubjectID"
                                    DataTextField="Subject_Name" DataSourceID="ObjElecSub" Width="250">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="ObjElecSub" runat="server" SelectMethod="ddlElecSub1" TypeName="stdAttndance">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="cmbBatch" DefaultValue="0" Name="Batch" PropertyName="SelectedValue"
                                            Type="Int16" />
                                        <asp:ControlParameter ControlID="cmbSemester" DefaultValue="0" Name="Sem" PropertyName="SelectedValue"
                                            Type="Int16" />
                                        <asp:ControlParameter ControlID="cmbSubject" DefaultValue="0" Name="Subid" PropertyName="SelectedValue"
                                            Type="Int16" />
                                    </SelectParameters>
                                </asp:ObjectDataSource>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:ObjectDataSource ID="ObjCategory" runat="server" SelectMethod="GetCategoryyyALL"
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtFromDateExt" MaxLength="11" runat="server" SkinID="txt" TabIndex="8"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtToDateExt" MaxLength="11" runat="server" SkinID="txt" TabIndex="9"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlMin" runat="server" SkinID="ddl" TabIndex="10">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlMax" runat="server" SkinID="ddl" TabIndex="11">
                                    <asp:ListItem Text="100" Value="100"></asp:ListItem>
                                    <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="3" Value="3"></asp:ListItem>
                        ...
                        <caption>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <%--  <asp:ObjectDataSource ID="ObjBatch" runat="server" SelectMethod="GetOpenBatchCombo1"
                                        TypeName="DLNew_StudentMarks">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ddlBranch" Name="BranchCode" PropertyName="SelectedValue"
                                                Type="String" />
