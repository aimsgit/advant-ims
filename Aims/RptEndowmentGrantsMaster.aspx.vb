...
Partial Class RptEndowmentGrantsMaster
    Inherits BasePage

    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        msginfo.Text = ValidationMessage(1014)
        Dim QS As String
        Dim SponsorID As String
        ...
        Try
            If txtfromdate.Text <> "" And txttodate.Text <> "" Then
                ...
                If CType(txtfromdate.Text, Date) > CType(txttodate.Text, Date) Then
                    msginfo.Text = ValidationMessage(1076)
                    Exit Sub
                End If
            End If
            SponsorID = cmbSponsor.SelectedValue
            ...
            Dim qrystring As String = "RptEndowmentV.aspx?" & QueryStr.Querystring() & "&SponsorID=" & SponsorID & "&fromdate=" & fromdate & "&todate=" & todate
