<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Rpt_MonthlySalaryStatment.aspx.vb"
    Inherits="Rpt_MonthlySalaryStatment" %>
    ...
    <div>
        ...
        <center>
            <table>
                <tr>
                    <td align="center">
                        <asp:Label ID="lblFormName" Visible="true" runat="server" SkinID="lblB" Text="MONTHLY RUN"></asp:Label>
                    </td>
                </tr>
                <%--<tr>
                ...
                <tr>
                <td align="center" colspan="2">
                    <asp:Label ID="Lblexp" runat="server" SkinID="lblRed"></asp:Label>
                </td>
                </tr>
                <tr>
                    <td colspan="2">
