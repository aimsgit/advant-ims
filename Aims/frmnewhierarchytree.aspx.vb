...
Partial Class frmnewhierarchytree
    Inherits BasePage
    ...
    Protected Sub GotoParent_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles GotoParent.Click
        Try
            ...
            Session("Form") = "Default2.aspx"
            Response.Redirect("Default3.aspx")
            'ScriptManager.RegisterStartupScript(Page, Page.GetType(), "message", "<script>window.location.href('Main.aspx','_parent')</script>", False)
        ...
        Try
            ...
            Else
                ...
                If CInt(split(0)) > CInt(Session("Accesslevel")) Then
                    ...
                    lblParentBranch.Text = "You are Here >> " + Session("BranchName")
                    'ScriptManager.RegisterStartupScript(Page, Page.GetType(), "message", "<script>window.open('Main.aspx','_parent');</script>", False)
                    Session("Form") = "Default2.aspx"
                    Response.Redirect("Default3.aspx")
                    lblmsg.Text = ""
