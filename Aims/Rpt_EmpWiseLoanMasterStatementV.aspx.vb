...
Partial Class Rpt_EmpWiseLoanMasterStatementV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = Rpt_EmpWiseLoanMasterStatementDL.GenerateEmpWiseLoanMasterStatementReport(EmpId, FDate, TDate)
        Try
            If dt1.Rows.Count > 0 Then
                Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
                Me.ReportViewer1.LocalReport.ReportPath = "Rpt_EmpWiseLoanMasterStatement.rdlc"
                dt = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_proc_EmpWiseLoanMasterStatementReport", dt1)
