...
Partial Class Rpt_SaleReturnNewV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        Dim Buyer As Integer = Request.QueryString.Get("Buyer")
        Dim FromDate As DateTime = Request.QueryString.Get("fromdate")
        Dim ToDate As DateTime = Request.QueryString.Get("todate")

        QueryStr.GetValue(Page.Request, Prop)
        dt1 = DL.GetSaleReturnReport(Buyer, FromDate, ToDate)
        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Rpt_SaleReturnNew.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_Rpt_GetSaleReturn", dt1)
