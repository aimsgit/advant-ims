<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="Rpt_EthnicGenderWiseStudent.aspx.vb"
    Inherits="Rpt_EthnicGenderWiseStudent" Title="Composition of Ethnic/Gender wise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Composition of Ethnic/Gender wise</title>
                ...
                <center>
                    <table>
                        <tr>
                            ...
                            <td align="left">
                                &nbsp;<asp:DropDownList ID="ddlBranchName" TabIndex="1" runat="server" SkinID="ddlRsz" Width="350px"
                        ...
                        <tr>
                            <td align="right">
                                <asp:Label ID="lblStream" runat="server" Text="View By&nbsp;:&nbsp;" SkinID="lblRsz" Width="100px"></asp:Label>
                            </td>
                            <td align="left">
                                &nbsp;<asp:DropDownList ID="ddlView" TabIndex="1" runat="server" SkinID="ddlRsz" Width="100px">
                                    <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="Gender" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Ethnic" Value="2"></asp:ListItem>
                                </asp:DropDownList>
