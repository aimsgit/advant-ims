<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStudyCertificate.aspx.vb"
    Inherits="RptStudyCertificate" Title="Study Certificate" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div>
                    <center>
                        <h1 class="headingTxt">
                            <asp:Label ID="Labelstc" runat="server" Text="STUDY CERTIFICATE" SkinID="lblRepRsz"
                                Width="290" Visible="True"></asp:Label>
                        </h1>
                    </center>
                    <center>
                        <table class="custTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DDLCountry" runat="server" SkinID="ddlRsz" DataSourceID="ObjCountry"
                                        DataTextField="Country"  DataValueField ="countryId" AutoPostBack="true" TabIndex="5" Width="200">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4" class="btnTd">
                                    <asp:Button ID="btnReport" runat="server" CssClass="ButtonClass" SkinID="btn" Text=" REPORT" CommandName="REPORT"
                                        TabIndex="8" />
