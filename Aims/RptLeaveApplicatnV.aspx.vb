...
Partial Class RptLeaveApplicatnV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim LeaveStatus As Integer
        Dim Dept, Emp, LeaveType As Integer
        ...
        dt1 = Dl.RptLeaveApplcationDetailed(Dept, Emp, LeaveType, LeaveStatus, FrmDate, ToDate)
        Try
            If dt1.Rows.Count > 0 Then
                Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
                Me.ReportViewer1.LocalReport.ReportPath = "RptLeaveAppication.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_GetLeaveApplicationDetails", dt1)
