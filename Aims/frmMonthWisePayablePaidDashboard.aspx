<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="frmMonthWisePayablePaidDashboard.aspx.vb" Inherits="frmMonthWisePayablePaidDashboard" %>
    ...
    <asp:UpdatePanel ID="UP1" runat="server">
        <ContentTemplate>
            <center>
                <br />
                <h1 class="headingTxt">
                    MONTHWISE PAYABLES PAID STATUS
                </h1>
                <br /><br />
            </center>
            <center>
