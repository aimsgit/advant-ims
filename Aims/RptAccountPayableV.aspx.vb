...
Partial Class RptAccountPayableV
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim PatyTypeId As String = Request.QueryString.Get("PatyTypeId")
        Dim PartyNameId As String = Request.QueryString.Get("PartyNameId")
        QueryStr.GetValue(Page.Request, Prop)

        dt1 = Mfg_DLStockAudit.GetAccountPayable(PatyTypeId, PartyNameId, StartDate, EndDate)

        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "RptAccountPayable.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_Rpt_GetAccountPayable", dt1)
