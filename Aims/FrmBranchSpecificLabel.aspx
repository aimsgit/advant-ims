<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmBranchSpecificLabel.aspx.vb"
    Inherits="FrmBranchSpecificLabel" Title="Branch Specific Label Entry" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Branch Specific Label Entry</title>
                ...
                <div>
                    ...
                    <center>
                        <table class="custTable">
                            ...
                            <tr>
                                ...
                                <td align="Left">
                                    ...
                                    <asp:ObjectDataSource ID="ObjBranch" runat="server" OldValuesParameterFormatString="original_{0}"
                                        SelectMethod="insertBranchCombo" TypeName="DLMultilingual"></asp:ObjectDataSource>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="LblTrans" runat="server" SkinID="lblRsz" Width="150px" Text="Label Text* :&nbsp;&nbsp;"></asp:Label>
                                </td>
                                <td align="left">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Panel ID="panel1" runat="server" ScrollBars="Auto" Width="650px" Height="300px">
                                <asp:GridView ID="GVLabel" runat="server" AutoGenerateColumns="False" SkinID="GridView"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Module Name" SortExpression="ModuleName">
                                            <ItemTemplate>
                                                <asp:HiddenField ID="ModuleH" runat="server" Value='<%#Bind("BS_Label_AutoID") %>' />
                                        ...
                                        <asp:TemplateField HeaderText="Branch" SortExpression="BranchName">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbllangid" runat="server" Visible="false" Text='<%# Bind("BranchCode") %>'></asp:Label>
