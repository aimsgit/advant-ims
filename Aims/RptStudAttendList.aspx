<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStudAttendList.aspx.vb"
    Inherits="RptStudAttendList" Title="SEMESTER ATTENDANCE LIST" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                ...
                <br />
                <br />
                     <asp:Label ID="LabelSemAt" runat="server" Text="SEMESTER ATTENDANCE LIST" SkinID="lblRepRsz"
                        ...
                        <table>
                            <tr>
                                <td colspan="4" class="btnTd">
                                    <asp:Button ID="Btnreport" runat="server" CausesValidation="True" Text="REPORT" SkinID="btn" CommandName="REPORT" TabIndex="9" CssClass="ButtonClass " />
                                    &nbsp;<asp:Button ID="btnBack" CommandName="BACK" runat="server" CssClass="ButtonClass" SkinID="btn"
