<%@ Page Title="PENDING PO" Language="VB" AutoEventWireup="false"
    CodeFile="Mfg_rptPendingPO.aspx.vb" Inherits="Mfg_rptPendingPO" %>
                ...
                <center>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSupplier" runat="server" SkinID="ddlRsz" AutoPostBack="True" Width="300px"
                                    DataSourceID="odsSupplier" DataTextField="Supp_Name" DataValueField="Supp_Id"
                                    AppendDataBoundItems="true">
                                    
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="odsSupplier" runat="server" TypeName="Mfg_DLSaleReturn"
