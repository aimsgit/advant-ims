...
Partial Class RptAnnualSalaryStatementVNew
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DLAnnualSalaryStatment.RptAnnualStatmentNew(FromYear, ToYear, FromMonth, ToMonth, Dept, Empid)
        Try
            If dt1.Rows.Count > 0 Then
                Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
                Me.ReportViewer1.LocalReport.ReportPath = "RptAnnualSalaryStatementNew.rdlc"
                dt = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Proc_AnnualReport", dt1)
