<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptFRROBonafideCerti.aspx.vb"
    Inherits="RptFRROBonafideCerti" Title="FRRO Bonafide Certificate" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>FRRO Bonafide Certificate</title>
    ...
    <center>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div>
                    <center>
                        <asp:Label ID="Labelfr" runat="server" Text="FRRO BONAFIDE CERTIFICATE" SkinID="lblRepRsz" Width="320" Visible="True"></asp:Label>
                    </center>
                    <br />
                    <center>
