...
Partial Class RptTechEmpDetails
    Inherits BasePage
    'Dim BL As New EmpTranferB
    Dim DL As New DLRptTechEmpDetails
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If id <> "" Then
            ...
            Dim qrystring As String = "RptTechEmpDetailsV.aspx?" & QueryStr.Querystring() & "&id=" & id & "&Designation=" & Designation & "&SalaryGrade=" & SalaryGrade & "&DeptId=" & DeptId
    ...
    Protected Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            dt = DLRptTechEmpDetails.finalDynEmpRptAICTE()
