<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptElectiveMap.aspx.vb"
    Inherits="RptElectiveMap" Title="Elective Map Report" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Elective Map Report</title>
                ...
                <center>
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlElecSubj" runat="server" DataSourceID="ObjElecSubject" Width="200px"
                                    DataTextField="Subject_Name" DataValueField="Subject_Code" SkinID="ddlRsz" TabIndex="4">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="ObjElecSubject" runat="server" SelectMethod="GetAllElecSubjectDDl"
