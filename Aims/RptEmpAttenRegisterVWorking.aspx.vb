...
Partial Class RptEmpAttenRegisterVWorking
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DL.GetEmpAttenRegisterRptWorkingHours(Dept, Emp, FrmMonth, ToMonth, FrmYear, ToYear)
        Try
            If dt1.Rows.Count > 0 Then
                Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
                Me.ReportViewer1.LocalReport.ReportPath = "RptEmpAttenRegisterWorking.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_NewEmpAttendanceWorking", dt1)
