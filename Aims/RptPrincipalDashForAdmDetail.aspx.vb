...
Partial Class RptPrincipalDashForAdmDetail
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DL.GetAdmissionDet(AcademicYear, Course, Category, A_Race)
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "RptPrincipalDashForAdmDetail.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_GetPrinicipalDashAdmissionDet", dt1)
