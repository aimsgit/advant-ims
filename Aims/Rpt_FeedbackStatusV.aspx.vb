...
Partial Class Rpt_FeedbackStatusV
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DLRptFeedbackStatus.GetFeedBackStatus(CourseId, BatchId, SemId)
        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Rpt_FeedbackStatus.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_FeedBackNotSubmitted", dt1)
