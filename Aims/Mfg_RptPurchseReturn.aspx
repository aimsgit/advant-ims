<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_RptPurchseReturn.aspx.vb" Inherits="Mfg_RptPurchseReturn" title="Purchase Return" %>
  ...
  <form id="Form1" runat="server">
    ...
    <center>
        ...
        <table>
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList ID="cmbSuppName" runat="server" DataSourceID="ObjectDataSource1"
                        DataTextField="Supp_Name" SkinID="ddl" AutoPostBack="true" 
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="Label2" runat="server" Text="Purchase Return :&nbsp;&nbsp;" SkinID="lblRsz"></asp:Label>
                </td>
                <td align="left">
                   <asp:DropDownList ID="cmbPurRet" runat="server" 
                        DataTextField="PurchaseReturnNumber" SkinID="ddl" DataSourceID="ObjectDataSource2" 
                        DataValueField="Purchase_Return_ID" TabIndex="2" >                        
                    </asp:DropDownList>
                  <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetPurRet"
                        TypeName="Mfg_RptPurchaseReturnBL">
                        <SelectParameters>
