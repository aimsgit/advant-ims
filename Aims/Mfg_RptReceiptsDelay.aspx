<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_RptReceiptsDelay.aspx.vb"
    Inherits="Mfg_RptReceiptsDelay" Title="RECEIPTS DELAY" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>RECEIPTS DELAY</title>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="DDlBuyer" SkinID="ddlRsz" AutoPostBack="true" DataSourceID="ObjBuyer"
                                    DataTextField="Party_Name" DataValueField="Party_Id" runat="server" Width="300px">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="ObjBuyer" runat="server" SelectMethod="BuyerComboAllNew" TypeName="MfgSaleInvoiceDL">
