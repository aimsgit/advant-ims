...
Imports System.IO
Partial Class RptTechEmpDetailsV
    Inherits BasePage
    ...
    Private Sub CreateDynamicTable()
        ...
        Dim SalaryGrade As Integer = Request.QueryString.Get("SalaryGrade")
        ...
        'Dim SortBy As Iteger = Request.QueryString.Get("SortBy")
        dt = DLRptTechEmpDetails.finalEmpRptAICTE(ID, Designation, SalaryGrade, DeptId)
