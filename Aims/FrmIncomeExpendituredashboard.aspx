<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="FrmIncomeExpendituredashboard.aspx.vb"
    Inherits="FrmIncomeExpendituredashboard" Title="Income Expenditure dashboard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Income Expenditure dashboard</title>
                    ...
                    <center>
                        <table>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="Txtfdate" runat="server" SkinID="txt" MaxLength="11" TabIndex="1"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="Txttodate" runat="server" SkinID="txt" MaxLength="11" TabIndex="2"></asp:TextBox>
                ...
                <center>
                    <asp:Panel ID="Panel2" runat="server" Height="500px" Width="750px" ScrollBars="Auto">
                        <asp:Chart ID="Chart1" runat="server" Height="450px" Width="750px" EnableViewState="true">
                            ...
                            <Series>
                                <asp:Series Name="Series1" IsValueShownAsLabel="True" Legend="Legend1" LegendText="Income & Expenditure"
