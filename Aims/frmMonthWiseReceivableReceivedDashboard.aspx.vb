...
Partial Class frmMonthWiseReceivableReceivedDashboard
    Inherits BasePage
    Dim dt As DataTable
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        Try
            ...
            dt = Dl.MonthWiseReceivableReceived(year)
            If dt.Rows.Count = 0 Then
                lblRed.Text = "No records to display."
            Else

                Dim Receivable, Received As Double
                Dim Month As String
                If dt.Rows(0).Item("Receivable") Is DBNull.Value Then
                    Receivable = 0

                Else
                    Receivable = dt.Rows(0).Item("Receivable")
                End If
                If dt.Rows(0).Item("Received") Is DBNull.Value Then
                    Received = 0
                Else
                    Received = dt.Rows(0).Item("Received")
                End If
                ...
                End If
                Chart1.Series("Series1").YValueMembers = "Receivable"
                Chart1.Series("Series1").XValueMember = "Month"
                Chart1.Series("Series2").YValueMembers = "Received"
