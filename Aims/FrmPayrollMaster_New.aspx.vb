...
Partial Class FrmPayrollMaster_New
    Inherits BasePage
    ...
    Public Property dir() As SortDirection
        ...
        End Set
    End Property
    'Code written fro multilingual by Niraj on 05 aug 2014
    ''Retriving the text of controls based on Language

    Sub BranchSpecificLabel()
        Dim j As Integer
        Dim k As Integer
    ...
    Public Sub Control_Text_Label()
        ...
        dtll = GlobalFunction.GetChangeLabel(FormName)
