...
Partial Class RptCategory
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = CategoryDB.GetCategoryRpt()
        If dt1.Rows.Count > 0 Then
            ReportViewer1.LocalReport.ReportPath = "rptCategory.rdlc"
            dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Proc_RptCategory", dt1)
