<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_frmPurchaseReturn.aspx.vb"
    Inherits="Mfg_frmPurchaseReturn" Title="Purchase Return" %>
...
<script src="js/Tvalidate.js" type="text/javascript"> </script>
    ...
    <script type="text/javascript" language="javascript">
        function Valid() {
            ...
            msg = Field50N(document.getElementById("<%=txtReturnNo.ClientID %>"), 'Return No');
            if (msg != "") return msg;
        ...
        <ContentTemplate>
            <a name="Top">
                ...
                <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" CssClass="ajax__tab_xp"
                    BackColor="#E2E3BB">
                    <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="Purchase Return"
                        TabIndex="1">
                        <ContentTemplate>
                            <div>
                                <center>
                                    ...
                                    <asp:GridView ID="GridPurchaseReturnM" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Supplier">
                                                <ItemTemplate>
                                                    <asp:HiddenField ID="ID" runat="server" Value='<%# Bind("PurchaseReturnID") %>' />
                                            ...
                                            <asp:TemplateField HeaderText="Return No.">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPurchReturnId" runat="server" Visible="false" Text='<%# Bind("Purchase_Return_ID") %>'></asp:Label>
                                                    <asp:Label ID="lblPurchReturnNo" runat="server" Text='<%# Bind("PurchaseReturnNumber") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Return Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblReturnInvoiceDateGV" runat="server" Text='<%# Bind("PurchaseReturnDate","{0:dd-MMM-yyyy}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" />
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                <HeaderStyle HorizontalAlign="Center" />
                    ...
                    <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="Purchase Return Details"
                        TabIndex="2">
                        <ContentTemplate>
                            <center>
                                <h1 class="headingTxt">
                            ...
                            <center>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="DDLProduct" SkinID="ddl" runat="server" DataValueField="Product_Id"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlBatch" SkinID="ddl" runat="server" DataSourceID="ObjBatch"
                                                DataValueField="Batchid" DataTextField="BatchNo" AutoPostBack="true">
                                                <asp:ListItem Value="0">Select</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:ObjectDataSource ID="ObjBatch" runat="server" SelectMethod="GetBatchDDL" TypeName="Mfg_DLPurchaseReturn">
                                                <SelectParameters>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            <asp:Label ID="lblMFG" SkinID="lbl" runat="server" Text="MFG&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtMfg" runat="server" Enabled="false" SkinID="txt"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="right">
                                            <asp:Label ID="lblMkt" runat="server" Text="MKT :&nbsp;&nbsp;" SkinID="lblRsz"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtMKT" runat="server" Enabled="false" SkinID="txt"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtFlatRate" runat="server" Style="text-align: right" Enabled="false" SkinID="txt"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtQtyIn" SkinID="txt" Style="text-align: right" Enabled="false" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtUsedQty" SkinID="txt" Style="text-align: right" Enabled="false" runat="server"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtNetUsableQty" SkinID="txt" Style="text-align: right" Enabled="false" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                    ...
                                                    <asp:GridView ID="GVPRDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Inv No.">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="GVPurchaseInvoiceNO" runat="server" Text='<%# Bind("Purchase_Invoice_No") %>'></asp:Label>
                                                                    <asp:Label ID="GVPurchaseInvoiceID" runat="server" Visible="false" Text='<%# Bind("Purchase_Invoice_ID")%>' />
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Product">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HiddenField ID="GVPR_ID" runat="server" Value='<%#Bind("PR_ID") %>' />
                                                                    <asp:HiddenField ID="GVPRID" runat="server" Value='<%#Bind("PRID") %>' />
                                                                    <asp:HiddenField ID="GVSupplier" runat="server" Value='<%#Bind("Company_ID") %>' />
                                                                    <asp:Label ID="lblGVReturnId" runat="server" Visible="false" Text='<%# Bind("Purchase_Return_ID")%>' />
                                                                ...
                                                                --%>
                                                                    ...
                                                                    <asp:HiddenField ID="Producttype" runat="server" Value='<%# Bind("Field1") %>' />
                                                            ...
                                                            <asp:TemplateField HeaderText="MFG">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="gvlblMFG" runat="server" Text='<%# Bind("MFG") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" />
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="MKT">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="GVlblMKT" runat="server" Text='<%# Bind("MKT") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Left" />
                                                                <HeaderStyle HorizontalAlign="Left" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Exchange Rate">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="GVlblExchangeRate" runat="server" Text='<%# Bind("Currency_Rate","{0:0.00}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Qty Returned">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblQtyRecvdID" runat="server" Text='<%# Bind("Qty_Returned","{0:0.00}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                <HeaderStyle HorizontalAlign="Right" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Flat_Rate">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="GVLblFlat_Rate" runat="server" Text='<%# Bind("Flat_Rate","{0:0.00}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                <HeaderStyle HorizontalAlign="Right" />
                                                            </asp:TemplateField>
