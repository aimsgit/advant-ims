<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GeneralPartyLedger.aspx.vb"
    Inherits="RptGeneralPartyLedgerV" Title="General Party Ledger" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>General Party Ledger</title>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" OnClientPopulated="HideImage"
                                    ...
                                    ServicePath="TextBoxExt.asmx" EnableCaching="true">
