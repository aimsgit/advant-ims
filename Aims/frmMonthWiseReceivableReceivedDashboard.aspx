<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="frmMonthWiseReceivableReceivedDashboard.aspx.vb" Inherits="frmMonthWiseReceivableReceivedDashboard" %>
 ...
 <asp:UpdatePanel ID="UP1" runat="server">
        <ContentTemplate>
            <center>
                <br />
                <h1 class="headingTxt">
                    MONTHWISE RECEIVABLES RECEIVED STATUS
                </h1>
                <br />
            </center>
            <center>
