<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptSemMarksnAttenListParentLogin.aspx.vb"
    Inherits="RptSemMarksnAttenListParentLogin" Title=" SEMESTER MARKS AND ATTENDANCE LIST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SEMESTER MARKS AND ATTENDANCE LIST</title>
                    ...
                    <center>
                        <table>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtBatch" runat="server" SkinID="txtRsz" Width="200" TabIndex="1" Enabled=false></asp:TextBox>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="DDLSemester" SkinID="ddlRsz" DataValueField="SemCode" DataTextField="SemName"
                                        AutoPostBack="true" AppendDataBoundItems="false" runat="server" Width="200" TabIndex="2">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlassessment" SkinID="ddlRsz" runat="server" DataTextField="AssessmentType"
                                        DataValueField="ID" TabIndex="3" Width="240px">
