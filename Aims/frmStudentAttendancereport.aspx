<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmStudentAttendancereport.aspx.vb"
    Inherits="frmStudentAttendancereport" Title="Student Attendance Report" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div>
                <center>
                    <h1 class="headingTxt">
                        STUDENT ATTENDANCE(WITH CLASS TYPE)</h1>
                </center>
                <center>
                    <br />
                    <br />
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="cmbSubject" TabIndex="5" runat="server" SkinID="ddlRsz" DataValueField="Subject_Code"
                                    DataTextField="Subject_Name" DataSourceID="ObjSubject" Width="250">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlClasstype" TabIndex="6" runat="server" SkinID="ddlRsz" DataValueField="code"
                                    DataTextField="classType" DataSourceID="ObjClassType" Width="250">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table>
                        ...
                        <caption>
                            &nbsp;<%--<asp:RequiredFieldValidator id="RequiredFieldValidator1" tabIndex="1" runat="server" ValidationGroup="Submit" ErrorMessage="Subject Field Null" ControlToValidate="ddlBatch">*</asp:RequiredFieldValidator>--%>
                            <tr>
                                <td>
                                    ...
                                    <asp:ObjectDataSource ID="ObjSubject" runat="server" SelectMethod="GetSubjectAll1" TypeName="DLReportsR">
                                        <SelectParameters>
                                        <asp:ControlParameter ControlID="ddlBranch" Name="BranchCode" PropertyName="SelectedValue"
                                                Type="String" />
