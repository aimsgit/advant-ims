...
Partial Class EmployeeIDV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DLStudentIDCard.EmployeeIDCard(branch, Ecode, DeptID)
        If dt1.Rows.Count > 0 Then
            ReportViewer1.LocalReport.ReportPath = "EmployeeID.rdlc"
            dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_RptEmployeeIDCard", dt1)
