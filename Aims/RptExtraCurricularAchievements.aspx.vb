...
Partial Class RptExtraCurricularAchievements
    Inherits BasePage
    ...
    Protected Sub Btnreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnreport.Click
        ...
        Try
            ...
            Dim qrystring As String = "RptExtraCurricularAchievementsV.aspx?" & QueryStr.Querystring() & "&DeptID=" & DeptID & "&FromDate=" & FromDate & "&ToDate=" & ToDate
