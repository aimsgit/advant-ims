...
Partial Class rptAssetBookTransfer
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        ReportViewer1.LocalReport.ReportPath = "rptAssetBookTransfer.rdlc"
        dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Qry_AssetBookTransfer", BLL.AssetBookTransferReport(Request.QueryString(1), Request.QueryString(0), assettype, asset))
