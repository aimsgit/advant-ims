...
Partial Class rpt_frmProductPriceList
    Inherits BasePage
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "rpt_frmProductPriceListV.aspx?" & QueryStr.Querystring() & "&ProductId=" & ProductId & "&SupplierId=" & SupplierId & "&category=" & category
