<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Rpt_ServiceRequest.aspx.vb"
    Inherits="Rpt_ServiceRequest" Title="Service Request Report" %>
            ...
            <center>
                <table>
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtStartingDate" runat="server" Width="150px" SkinID="txtRsz"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtEndDate" runat="server" Width="150px" SkinID="txtRsz"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true" SkinID="ddl"
                                TabIndex="1">
