...
Partial Class RPT_SteramWiseUniversityStudCount
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DL.UniStudentStudCountStreamWise(BranchCode, StartDate, EndDate, Stream)
        'If Right(BranchCode, 8) = "00000000" Then
        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Rpt_UniStudCountStreamWise.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_UniStudentcountStreamWise", dt1)
