<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_RptSaleReturnNew.aspx.vb"
    Inherits="Mfg_RptSaleReturnNew" Title="Sale Return Report" %>
                    ...
                    <table>
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:ObjectDataSource ID="ObjBuyer" runat="server" SelectMethod="BuyerComboAll" TypeName="MfgSaleInvoiceDL">
