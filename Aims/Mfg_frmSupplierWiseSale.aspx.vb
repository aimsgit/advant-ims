...
Partial Class Mfg_frmSaleInvoiceSummary
    Inherits BasePage
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "Mfg_Rpt_SupplierWiseSale.aspx?" & QueryStr.Querystring() & "&Fromdate=" & Fromdate & "&Todate=" & Todate & "&Party=" & Party
