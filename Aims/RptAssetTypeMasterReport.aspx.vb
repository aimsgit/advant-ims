...
Partial Class RptAssetTypeMasterReport
    Inherits BasePage
    Dim bll As New DLAssetType
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim AssetTypeR, BranchType, BranchName, SlNo, AssetType, AssetTypeCode, AssetTypeDescription As String
        AssetTypeR = dt2.Rows(0).Item("Default_Text").ToString()
        ...
        AssetTypeCode = dt2.Rows(5).Item("Default_Text").ToString()
        AssetTypeDescription = dt2.Rows(6).Item("Default_Text").ToString()
        dt1 = DLAssetType.RptAssetType()
        Try
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "RptAssetType.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_proc_GetAssetTypeMasterDetails", dt1)
                Dim paramList As New Generic.List(Of Microsoft.Reporting.WebForms.ReportParameter)
                paramList.Add(New Microsoft.Reporting.WebForms.ReportParameter("AssetTypeR", AssetTypeR, False))
                ...
                paramList.Add(New Microsoft.Reporting.WebForms.ReportParameter("AssetTypeDescription", AssetTypeDescription, False))
