<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NewRptDayBook.aspx.vb" Inherits="NewRptDayBook" title="SHROFF ENTRY REPORT" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SHROFF ENTRY REPORT</title>
        ...
        <ContentTemplate>
            <center>
                ...
                <table>
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlReportType" runat="server" SkinID="ddl" DataTextField="Acct_Group"
                                DataValueField="Acct_Group_ID" TabIndex="1" AutoPostBack="true">
                                <asp:ListItem Value="0"> All</asp:ListItem>
                                <asp:ListItem Value="1">Voucher Wise Report</asp:ListItem>
                                <asp:ListItem Value="2">Cheque Wise Report</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label4" runat="server" Text="From No :&nbsp;&nbsp;" SkinID="lblRsz"
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label5" runat="server" Text="To No :&nbsp;&nbsp;" SkinID="lblRsz"
                                Width="160px"></asp:Label>
                        </td>
                        <td>
                            ...
                            <asp:ObjectDataSource ID="objSerial" runat="server" SelectMethod="GetNo" TypeName="DayBookDB">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlReportType" PropertyName="SelectedValue" Name="Type" />
                                </SelectParameters>
