...
Partial Class RptSalaryStop
    Inherits BasePage
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        'Code for Salary Stop Report by Shwetha 2014/12/05
        lblmsg.Text = ""
        msginfo.Text = ""
      
        Dim fromdateE As DateTime
        Dim todateE As DateTime
        Dim BranchCod As String
        BranchCod = HttpContext.Current.Session("BranchCode")
        ...
        If fromdateE > todateE Then
            ...
            Exit Sub
        End If
        Dim qrystring As String = "RptSalaryStopV.aspx?" & QueryStr.Querystring() & "&StartDate=" & fromdateE & "&EndDate=" & todateE
