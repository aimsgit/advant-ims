...
Imports System.IO
Partial Class RptStudentDetailsDynamic
    Inherits BasePage
    Dim bl As New DLStudentDetAICTE
    ...
    Private Sub CreateDynamicTable()
        ...
        Dim str1 As String = Request.QueryString.Get("str")
        Dim semid As Integer = Request.QueryString.Get("semid")
        Dim semid1 As Integer = Request.QueryString.Get("semid1")
        Dim semid2 As Integer = Request.QueryString.Get("semid2")
        Dim semid3 As Integer = Request.QueryString.Get("semid3")
        dt = DLStudentDetAICTE.StudentDynamicReport(Course, Batch, ID, str1, semid, semid1, semid2, semid3)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Page.Response.AddHeader("content-disposition", "attachment;filename=STUDENT DETAILS-AICTE FORMAT.xls")
