<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptEmployeeDesignationCount.aspx.vb" Inherits="RptEmployeeDesignationCount" title="Employee Designation Count" %>
                         ...
                         <tr>
                            ...
                            <td align ="left" >
                                ...
                                <asp:ObjectDataSource ID="ObjBranch" runat="server" OldValuesParameterFormatString="original_{0}"
                                    SelectMethod="GetBranchTypecombo" TypeName="EmpDesgB"></asp:ObjectDataSource>
                            </td>
                        </tr>
                          <tr>
                            <td>
