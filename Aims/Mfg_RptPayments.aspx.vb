...
Partial Class Mfg_RptPayments
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        If fromdateE > todateE Then
            ...
            Exit Sub
        End If
        Dim qrystring As String = "Mfg_RptPaymentsV.aspx?" & QueryStr.Querystring() & "&StartDate=" & fromdateE & "&EndDate=" & todateE & "&SupplierId=" & SupplierId
