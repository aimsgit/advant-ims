<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="Rpt_StreamwiseEnrollment.aspx.vb"
    Inherits="Rpt_StreamwiseEnrollment" Title="Stream wise Enrolment" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Stream wise Enrolment</title>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:ObjectDataSource ID="ObjBranch" runat="server" OldValuesParameterFormatString="original_{0}"
                                    SelectMethod="insertBranchCombo1" TypeName="DLReportsR"></asp:ObjectDataSource>
                                    <!--Old Method -: insertBranchCombo -->
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
