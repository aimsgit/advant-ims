<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptMonthlyRunReport.aspx.vb" Inherits="RptMonthlyRunReport" title="MONTHLY RUN" %>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            <asp:Panel ID="Admission" runat="server" Height="300px" ScrollBars="Auto" Width="210px">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:GridView ID="GVDynamic" runat="server" AutoGenerateColumns="false" SkinID="GridView">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Column Name">
                                                            <ItemTemplate>
                                                            <asp:Label ID="Label3" runat="server" Visible ="false"  Text='<%# Bind("LookUpAutoID") %>'></asp:Label>
