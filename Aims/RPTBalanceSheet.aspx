<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RPTBalanceSheet.aspx.vb"
    Inherits="RPTBalanceSheet" Title="Balance Sheet" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Account Group">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="LabelAccGroupId1" Width="50" runat="server" Text='<%# Bind("Acct_Group") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Account Group">
                            <ItemTemplate>
                                <asp:Label ID="LabelAccGroupId2" Width="50" runat="server" Text='<%# Bind("Acct_Group") %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
