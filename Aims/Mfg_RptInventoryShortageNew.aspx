<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_RptInventoryShortageNew.aspx.vb"
    Inherits="Mfg_RptInventoryShortageNew" Title="Inventory Shortage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Inventory Shortage</title>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:DropDownList ID="ddlProduct" runat="server" Width="250px" DataSourceID="ObjProduct"
                                    DataTextField="Product_Name" SkinID="ddlRsz" DataValueField="Product_Id" TabIndex="1">
                                </asp:DropDownList>
