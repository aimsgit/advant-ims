...
Partial Class NewRptDayBook
    ...
    Protected Sub Btnreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnreport.Click
        ...
        Else
            msginfo.Text = ""
            Dim qrystring As String = ConfigurationManager.AppSettings("ReportPath") & "NewRptDayBookV.aspx?" & QueryStr.Querystring() & "&FinStartDate=" & txtStartDate.Text & "&FinEndDate=" & txtEndDate.Text & "&S1=" & ddlS1.SelectedValue & "&S2=" & ddlS2.SelectedValue & "&ReportType=" & ddlReportType.SelectedValue
