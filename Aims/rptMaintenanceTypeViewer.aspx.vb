...
Partial Class BranchrptV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim BLL As New MaintenanceTypeDB
        Dim dtM As New Data.DataTable

        Dim ins As Int16 = Request.QueryString.Get("ins")
        Dim bran As Int16 = Request.QueryString.Get("bran")

        'dtM = MaintenanceTypeDB.GetMaintenanceType().Tables(0)

        If dtM.Rows.Count > 0 Then
            Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
            Me.ReportViewer1.LocalReport.ReportPath = "RptMaintenaceType.rdlc"
            dt = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Maintenance_Type", dtM)
