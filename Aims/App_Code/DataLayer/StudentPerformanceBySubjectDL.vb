...
Public Class StudentPerformanceBySubjectDL
    Public Function GetStudentNameCombo(ByVal Batch As Integer) As System.Data.DataTable
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "New_SelectStudent1", param)
    ...
    Public Function GetStudentNameCombo1(ByVal Batch As Integer) As System.Data.DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetStudentNameCombo2(ByVal Batch As String, ByVal Subgrp As Integer, ByVal Subject As Integer) As System.Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "New_SelectStudentComboOnSubgrpBySub", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
        Return ds.Tables(0)
