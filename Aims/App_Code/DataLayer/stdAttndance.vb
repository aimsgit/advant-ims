...
Public Class stdAttndance
    Public Function InsertAttandance(ByVal a As StdAttendanceP) As Integer
        ...
        Try
            Rowseffected = SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "New_InsertStudentAttendance", param)
        Catch ex As Exception
            MsgBox(ex)
        End Try
        Return Rowseffected
    End Function
    Public Function InsertAttandanceNosubject(ByVal a As StdAttendanceP) As Integer
        Dim Rowseffected As Integer = 0
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim param() As SqlParameter = New SqlParameter(9) {}
        param(0) = New SqlParameter("@A_Year", SqlDbType.Int)
        ...
        param(9).Value = a.SubGrp
        Try
            Rowseffected = SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "New_InsertStudentAttendanceNosubject", param)
        Catch ex As Exception
            MsgBox(ex)
        End Try
        Return Rowseffected
    End Function
    Public Function InsertAttandance1(ByVal a As StdAttendanceP) As Integer
        Dim Rowseffected As Integer = 0
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            Rowseffected = SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "New_InsertStudentAttendance1", param)
        Catch ex As Exception
            MsgBox(ex)
        End Try
        Return Rowseffected
    End Function
    Public Function GetAttendenceDateValue() As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "proc_GetAttendenceyear", param)
        Catch ex As Exception
    ...
    Public Function GetAttendenceConfiguration() As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "proc_GetAttendenceConfiguration", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetAttendenceConfigurationRoll() As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "proc_GetAttendenceConfigurationRoll", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetAttendenceConfigurationUser() As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
    ...
    Public Function GetByGVStdAttd(ByVal a As StdAttendanceP) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "New_ViewStudentAttendance", param)
            Return ds.Tables(0)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
    End Function
    Public Function GetByGVStdAttdRpt(ByVal AYear As Integer, ByVal Batch As Integer, ByVal Semester As Integer, ByVal Subject As Integer, ByVal AttenDate As Date, ByVal SubGrp As Integer, ByVal SessionCountDay As String) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        End Try
    End Function
    Public Function Attendanceduplicate1(ByVal a As StdAttendanceP) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "proc_AttendanceDuplicate1", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
        ...
        Return ds.Tables(0)
    End Function
    Public Function Attendanceduplicate(ByVal a As StdAttendanceP) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "proc_AttendanceDuplicate", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
    ...
    Public Function GetBatch(ByVal a As StdAttendanceP) As Data.DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetBatchNosubject(ByVal a As StdAttendanceP) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        'param(5).Value = a.ElecSub
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "proc_GetBatchStatusNosubject", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetStudentReport(ByVal Bat As Integer, ByVal Sem As Integer, ByVal Subj As Integer, ByVal CT As Integer, ByVal StdId As Integer, ByVal fromdate As DateTime, ByVal todate As DateTime, ByVal Min As Integer, ByVal Max As Integer, ByVal SortBy As Integer, ByVal categ As Integer) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        param(11) = New SqlParameter("@Category", SqlDbType.Int)
        param(11).Value = categ
        Try
    ...
    Public Function UpdateCollectionVerification(ByVal a As StdAttendanceP) As Integer
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim Rowseffected As Integer = 0
        ...
        param(8).Value = a.SubGrp
        Try
            Rowseffected = SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "New_UpdateAllAttendance", param)
        Catch ex As Exception
            MsgBox(ex.Data.ToString)
        End Try
    ...
    Public Function UpdateRecord(ByVal a As StdAttendanceP) As Integer
        ...
        Try
            Rowseffected = SqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, "New_UpdateAttendance", param)
        Catch ex As Exception
            MsgBox(ex)
        End Try
        Return Rowseffected
    ...
    Shared Function ddlElecSub(ByVal Batch As Integer, ByVal Sem As Integer, ByVal Elecid As Integer) As DataTable
        ...
        Return ds.Tables(0)
    End Function
    Public Function GetNewStudentAttendanceReportwitDate(ByVal BR As String, ByVal Bat As Integer, ByVal Sem As Integer, ByVal Subj As Integer, ByVal FromDate As Date, ByVal ToDate As Date, ByVal SortBy As Integer, ByVal SubjectSubgrp As Integer) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        ...
        param(8) = New SqlParameter("@SubjectSubgrp", SqlDbType.Int)
        param(8).Value = SubjectSubgrp
    ...
    Public Function GetSemAssessmtRpt(ByVal Crs As Integer, ByVal Bat As String, ByVal Sem As Integer, ByVal Subj As Integer, ByVal StdId As Integer, ByVal SortBy As Integer, ByVal AsstId As Integer, ByVal EmpStudLog As Integer) As Data.DataTable
        ...
        param(1) = New SqlParameter("@batch", SqlDbType.VarChar, 250)
        param(1).Value = Bat
    ...
    Public Function GetNewSemMarksAttendListNewReport(ByVal Bat As Integer, ByVal Sem As Integer, ByVal Aid As Integer, ByVal id As Integer, ByVal Srtdate As String, ByVal EndDate As String) As Data.DataTable
        ...
        Return ds.Tables(0)
    End Function
    Shared Function ViewDataStatusBySub(ByVal Batch As String) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        Dim Parms() As SqlParameter = New SqlParameter(1) {}
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "[Rpt_ViewAttendDataEntryStatusBySub]", Parms)
            Return ds.Tables(0)
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
    ...
    Shared Function MedicalLeave(ByVal Batchid As Integer, ByVal SemId As Integer) As Data.DataTable
        Dim connectionString As String = ConfigurationManager.ConnectionStrings("Advant").ConnectionString
        Dim ds As New DataSet
        Dim Parms() As SqlParameter = New SqlParameter(3) {}
        ...
        Try
            ds = SqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "Proc_MedicalLeave", Parms)
            Return Nothing
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
