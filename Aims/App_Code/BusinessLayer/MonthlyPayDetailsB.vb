...
Public Class MonthlyPayDetailsB
    ...
    Public Function ClearMarks(ByVal month As String, ByVal year As Integer, ByVal Dept As Integer) As Integer
        Return MD.ClearMarks(month, year, Dept)
    End Function
    ...
    'End Function
    Public Function duplicate(ByVal month As String, ByVal year As Integer, ByVal Dept As Integer) As Data.DataTable
        Return MD.duplicate(month, year, Dept)
    End Function
    ...
    End Function
    Public Function getgrid1(ByVal month As String, ByVal year As Integer, ByVal Dept As Integer) As Data.DataTable
        Return MD.getgrid1(month, year, Dept)
    End Function
