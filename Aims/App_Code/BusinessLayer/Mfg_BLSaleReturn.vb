...
Public Class Mfg_BLSaleReturn
    Dim DLL As New Mfg_DLSaleReturn
    Public Function insert(ByVal EL As Mfg_ELSaleReturn) As Integer
        Return DLL.Insert(EL)
    End Function

    Public Function Insertrecord(ByVal EL As Mfg_ELSaleReturn) As Integer
        Return DLL.Insertrecord(EL)
    End Function

    Public Function UpdateRecord(ByVal EL As Mfg_ELSaleReturn) As Integer
        Return DLL.UpdateRecord(EL)
    End Function
    Public Function update(ByVal EL As Mfg_ELSaleReturn) As Integer
    ...
    End Function
    Public Function DeletePurchasReturn(ByVal EL As Mfg_ELSaleReturn) As Integer
        Return DLL.DeletePurchasReturn(EL)
    End Function

    Public Function DeletePurchaseReturnS(ByVal EL As Mfg_ELSaleReturn) As Integer
    ...
    End Function
    Public Function GetPurchaserReturnS(ByVal EL As Mfg_ELSaleReturn) As DataTable
