...
Public Class Mfg_BLProductReceipe
    Dim DL As New Mfg_DLProductReceipe
    ...
    End Function
    Public Function DeteteProductReceipe(ByVal EL As Mfg_ELProductReceipeMaster) As Integer
        Return DL.DeteteProductReceipe(EL)
    End Function
   Public Function getProductDetailsReceipe(ByVal EL As Mfg_ELProductReceipeMaster) As DataTable
