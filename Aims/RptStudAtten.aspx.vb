    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Try
            If dt1.Rows.Count > 0 Then
                ...
                Me.ReportViewer1.LocalReport.ReportPath = "RptStudAtten.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_New_ViewStudentAttendance", dt1)
