...
Partial Class RptLeaveTypeV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        'ReportViewer1.LocalReport.ReportPath = "rptLeaveType.rdlc"
        'dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_LeaveTypes", LeaveTypesDB.GetReport)
