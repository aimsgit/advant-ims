...
Partial Class FrmCrmLeadReport
    Inherits BasePage
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "FrmCrmLeadReportV.aspx?" & QueryStr.Querystring() & "&ProductId=" & ProductId & "&StatusId=" & StatusId & "&fromdate=" & fromdate & "&todate=" & todate
