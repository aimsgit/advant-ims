<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmStudentMarksEntrybySubject.aspx.vb"
    Inherits="frmStudentMarksEntrybySubject" Title="Student Marks Entry by Subject"
    ValidateRequest="false" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Student Marks Entry by Subject</title>
                ...
                <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="Student Marks" TabIndex="1">
                    ...
                    <h1 class="headingTxt">
                        ENTER STUDENT MARKS</h1>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <asp:ObjectDataSource ID="ObjStudent" runat="server" SelectMethod="GetStudNameCombo"
                            ...
                            <asp:ObjectDataSource ID="ObjAcademic" runat="server" SelectMethod="GetAcademicComboBySub1"
                    ...
                    TypeName="DLNew_StudentMarks"></asp:ObjectDataSource>--%>
                            <asp:ObjectDataSource ID="ObjSemester" runat="server" SelectMethod="SemCombo1" TypeName="FeeCollectionBL">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlbatch" PropertyName="SelectedValue" Name="Batch"
                                        DbType="Int16" />
                                </SelectParameters>
                            </asp:ObjectDataSource>
                            <asp:ObjectDataSource ID="ObjSubject" runat="server" SelectMethod="GetSubComboBatchPlanner1"
                            ...
                            <asp:ObjectDataSource ID="ObjClassType" runat="server" SelectMethod="GetClassComboBySub"
                                TypeName="DLNew_StudentMarks"></asp:ObjectDataSource>
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlA_Year" DefaultValue="0" Name="A_Year" PropertyName="SelectedValue"
                            ...
                            <asp:ObjectDataSource ID="ObjBatch" runat="server" SelectMethod="getBatchPlanComboSelectAll1"
                                TypeName="DLBatchPlanner"></asp:ObjectDataSource>
                            <asp:ObjectDataSource ID="ObjAssesment" runat="server" SelectMethod="GetAssesmentComboBySub"
                                TypeName="DLNew_StudentMarks"></asp:ObjectDataSource>
    ...
    <center>
        ...
        <asp:Panel ID="Panel3" runat="server">
            ...
            <asp:Button ID="Btnback" SkinID="btnRsz" runat="server" CausesValidation="true" CssClass="ButtonClass"
                Text="IMPORT" Height="26px" CommandName="IMPORT" />
        </asp:Panel>
    </center>
    </form>
</body>
