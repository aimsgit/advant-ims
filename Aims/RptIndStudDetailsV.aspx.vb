...
Partial Class RptIndStudDetailsV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = StudentDB.GetIndStudDetailsRpt(BrID, AID, CID, BID, country, Student)
        If dt1.Rows.Count > 0 Then
            ReportViewer1.LocalReport.ReportPath = "RptIndStudDetails.rdlc"
            dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_IndStudDetails", dt1)
