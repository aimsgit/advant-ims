...
Partial Class Rpt_DistrictwiseStudentCountGraphV
    Inherits BasePage
    ...
    Dim DL As New DLRptDistrictwiseStudentCount
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DL.Rpt_DistrictwiseDashboard(BranchCode, StartDate, EndDate)

        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Rpt_Districtwise_Std_DashGraph.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_DistrictwiseStudentCount_Dashboard", dt1)
