...
Partial Class frmMonthWisePurchaseSalesReturnDashboard
    Inherits BasePage
    Dim dt As DataTable
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        Try
            ...
            dt = Dl.MonthWisePurchaseSalesReturn(year)
            ...
            Else
                ...
                Dim Month As String
                If dt.Rows(0).Item("PurchaseaReturnAmt") Is DBNull.Value Then
                    PurchaseAmt = 0

                Else
                    PurchaseAmt = dt.Rows(0).Item("PurchaseaReturnAmt")
                End If
                If dt.Rows(0).Item("SaleReturnAmt") Is DBNull.Value Then
                    SalesAmt = 0
                Else
                    SalesAmt = dt.Rows(0).Item("SaleReturnAmt")
                End If
                If dt.Rows(0).Item("MonthName1") Is DBNull.Value Then
                    Month = 0

                Else

                    Month = dt.Rows(0).Item("MonthName1")
                End If
                Chart1.Series("Series1").YValueMembers = "PurchaseaReturnAmt"
                Chart1.Series("Series1").XValueMember = "MonthName1"
                Chart1.Series("Series2").YValueMembers = "SaleReturnAmt"
                Chart1.Series("Series2").XValueMember = "MonthName1"
    ...
    Protected Sub Chart1_Customize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Chart1.Customize
        ...
        For Each dp1 As DataPoint In Chart1.Series("Series2").Points
            dp1.Color = Drawing.Color.Yellow
