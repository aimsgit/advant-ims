...
Partial Class RptDataStatusBySub
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Try
            ...
            dt1 = DLStdMarksElective.ViewDataStatusBySub(Batch, Semester, Subject)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                Me.ReportViewer1.LocalReport.ReportPath = "RptDataStatusBySub.rdlc"
