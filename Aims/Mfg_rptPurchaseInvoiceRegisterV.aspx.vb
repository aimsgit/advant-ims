...
Partial Class Mfg_rptPurchaseInvoiceRegisterV
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim Supplier As String = Request.QueryString.Get("SupplierId")
        QueryStr.GetValue(Page.Request, Prop)

        dt1 = Mfg_DLStockAudit.GetPurchaseInvoiceRegister(Supplier, StartDate, EndDate)

        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Mfg_rptPurchaseInvoiceRegister.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_RptPurchaseInvoiceRegister", dt1)
