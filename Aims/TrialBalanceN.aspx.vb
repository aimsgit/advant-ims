...
Partial Class TrialBalanceN
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        Try
            ...
            dt1 = DL.TrialBookReport1(fstartdate, fenddate)
            If dt1.Rows.Count > 0 Then
                ReportViewer1.LocalReport.ReportPath = "TrialBalance.rdlc"
                dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Test_TrialBalanceSheet", dt1)
