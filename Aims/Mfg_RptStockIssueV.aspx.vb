Partial Class Mfg_RptStockIssueV
    Inherits BasePage
    ...
    Dim DL As New DLStockIssueRrport
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = DLStockIssueRrport.GetStockIssue(StartDate, EndDate)

        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Mfg_RptStockIssue.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_RptStockIssue", dt1)
