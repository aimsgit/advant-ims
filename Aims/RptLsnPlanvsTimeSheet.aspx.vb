...
Partial Class RptLsnPlanvsTimeSheet
    Inherits BasePage
    ''Created By -->SHEELA
    ''Date-->02-mAY-2013
    ...
    Protected Sub Btnreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnreport.Click
        ...
        Try
            ...
            Dim qrystring As String = "RptLsnPlanvsTimeSheetV.aspx?" & QueryStr.Querystring() & "&BatchID=" & BatchID & "&SemID=" & SemID & "&SubjectID=" & SubjectID
