<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpttrialbalanceDrilDown.aspx.vb"
    Inherits="rpttrialbalanceDrilDown" Title="Trial Balance  DrillDown Day Book" %>
...
<head id="Head1" runat="server">
    <title>Trial Balance DrillDown Day Book</title>
</head>
<br />
<br />
<br />
    ...
    <div>
        ...
        <center>
            <asp:Panel ID="panel1" runat="server" ScrollBars="Auto" Width="650px" Height="500px">
                <asp:GridView ID="GVTrialBalanceDrillDown" runat="server" AllowPaging="True" AutoGenerateColumns="False"
