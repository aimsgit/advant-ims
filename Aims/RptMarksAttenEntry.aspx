<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptMarksAttenEntry.aspx.vb"
    Inherits="RptMarksAttenEntry" Title="Marks/Attendance Entry" %>
             ...
             <br />
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:RadioButtonList ID="RBUsers" runat="server" SkinID="RD" AutoPostBack="True"
                                    ...
                                    <asp:ListItem Value="M" Selected="True">Marks</asp:ListItem>
                ...
                <center>
                    <table class="custTable">
                        <tr>
                            <td align="right">
                                <asp:Label ID="Lblfdate" runat="server" Text="From Date&nbsp;:&nbsp;&nbsp;" SkinID="lblRsz"
