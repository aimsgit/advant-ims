...
Partial Class RptSalaryNewPayV
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim MonthNo As Integer = Request.QueryString.Get("MonthNo")
        QueryStr.GetValue(Page.Request, Prop)
        dt1 = DLAnnualSalaryStatment.RptSalaryNewPay(Year, Month, MonthNo, Dept)
        Try
            If dt1.Rows.Count > 0 Then
                Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
                Me.ReportViewer1.LocalReport.ReportPath = "RptSalaryNewPay.rdlc"
                dt = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Proc_SalaryNewPay", dt1)
