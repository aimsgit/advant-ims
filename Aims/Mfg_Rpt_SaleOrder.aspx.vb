...
Partial Class Mfg_Rpt_SaleOrder
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Try
            ...
            dt1 = DL.GetSaleOrderRpt(id)
            If dt1.Rows.Count > 0 Then
                Try

                    ReportViewer1.LocalReport.ReportPath = "Mfg_Rpt_SaleOrder.rdlc"
                    dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_GetSaleOrder", dt1)
