<%@ Page Title="Month wise stock status" Language="VB" AutoEventWireup="false"
    CodeFile="frmMonthWiseStockDashboard.aspx.vb" Inherits="frmMonthWiseStockDashboard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Month wise stock status</title>
                ...
                <asp:Chart ID="Chart1" runat="server" Height="450px" Width="750px" EnableViewState="true">
                    ...
                    <Series>
                        <asp:Series ChartArea="ChartArea1" Name="Series1" IsValueShownAsLabel="True" Legend="Legend1"
                            LegendText="Stock Values" Color="RosyBrown">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
