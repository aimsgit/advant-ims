<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptStudAttenWitElecSub.aspx.vb"
    Inherits="RptStudAttenWitElecSub" Title="STUDENT ATTENDANCE REGISTER" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
                <center>
                    <h1 class="headingTxt">
                        <asp:Label ID="LabelStdAt" runat="server" Text="STUDENT ATTENDANCE REGISTER" SkinID="lblRepRsz"
                        ...
                        <tr>
                            <td class="btnTd" align="center">
                                ...
                                &nbsp;<asp:Button ID="btnBack" runat="server" CssClass="ButtonClass" SkinID="btn"
                                    TabIndex="12" Text="BACK" CommandName="BACK" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:ObjectDataSource ID="ObjClassType" runat="server" SelectMethod="GetClassCombo"
                                        TypeName="DLResult"></asp:ObjectDataSource>
