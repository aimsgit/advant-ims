<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_frmSaleInvoiceNew.aspx.vb"
    Inherits="Mfg_frmSaleInvoiceNew" Title="Sale Invoice" %>
...
<script src="js/Tvalidate.js" type="text/javascript"> </script>
    <script type="text/javascript" language="javascript">
        function ShowImage() {
            GlbShowSImage(document.getElementById("<%=txtProduct.ClientID%>"));
        }
        function HideImage() {
            GlbHideSImage(document.getElementById("<%=txtProduct.ClientID%>"));
        }
    ...
    <script type="text/javascript" language="javascript">
        function Valid1() {
            ...
            msg = Field50(document.getElementById("<%=txtSaleInvoiceNO.ClientID %>"), 'Sale Invoice No');
            if (msg != "") {
                document.getElementById("<%= txtSaleInvoiceNO.ClientID %>").focus();
                return msg;
            }


            msg = ValidateDate(document.getElementById("<%=txtInvoiceDate.ClientID %>"), 'Invoice Date');
            if (msg != "") {
                document.getElementById("<%= txtInvoiceDate.ClientID %>").focus();
                return msg;
            }
            msg = AutoCompleteExtenderForThree(document.getElementById("<%=txtProduct.ClientID %>"), 'Item');
            if (msg != "") {
            ...
            if (msg != "") {
                document.getElementById("<%= txtTotalQty1.ClientID %>").focus();
                return msg;
            }
//            msg = Field1(document.getElementById("<%=txtMRP.ClientID %>"), 'MRP');
//            if (msg != "") {
...
//            }
    ...
    <script type="text/javascript">
        function KeyPressbutton(e) {
            if (window.event.keyCode == 13) {
                document.getElementById('<%= btnAddSaleInvoiceDetails.ClientID %>').focus();
                return false;
            }
            else {
                return true;
 ...
 if (window.event.keyCode == 13) {
        ...
        function Splitter() {
            var text = document.getElementById("<%=txtProduct.ClientID%>").value;
            var split = text.split(':');
            if (split.length > 0) {
                var ProductName = split[0]
                var ProductId = split[1]
                document.getElementById("<%=txtProduct.ClientID%>").innerText = ProductName;
                document.getElementById("<%=HidProductId.ClientID %>").innerText = ProductId;
                document.getElementById('<%=DDLBatch.ClientID%>').focus();

            }
            else {
                document.getElementById("<%=txtProduct.ClientID %>").innerText = "";
                document.getElementById("<%=HidProductId.ClientID %>").innerText = "";
                document.getElementById('<%=txtProduct.ClientID%>').focus();
            }
        }
    </script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        //Invoice = Invoice .concat(Line)

        function PrintInvoice() {

            var w = window.open("", "MsgWindow", "resizeable=yes,scrollbars=yes");
            var Invoice = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cash Invoice";
            var Line = "----------------------------------------";

            var BranchName = '<%= Session("BranchName") %>';
            var BranchAddress = '<%= Session("BranchAddress") %>';
            var EmpName = '<%= Session("EmpName") %>';
            //            var Invdate12 = '<%= Session("InvDate11") %>';

            var InvD = document.getElementById('<%=HidInvD.ClientID %>');
            w.document.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + BranchName);
            w.document.write("<style type=\"text/css\"> body{font-size: 17px;} </style>");
            w.document.write("<br>");
            w.document.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + BranchAddress);
            w.document.write("<br>");
            ...
            w.document.write("<br>");
            w.document.write("<br>");
            var InvoiceNo = document.getElementById("<%=txtSaleInvoiceNO.ClientID %>").value;
            w.document.write("Bill No: " + InvoiceNo);
            w.document.write("<br>");
            w.document.write("Bill Date: " + InvD.value);
            w.document.write("<br>");
            w.document.write(EmpName);
            w.document.write("<br>");
            w.document.write(Line);
            w.document.write("<br>");

            //            w.document.write("Item&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Qty&nbsp;&nbsp;&nbsp;&nbsp;Rate&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amt");
            w.document.write("<table ><tr><td align=\"left\" width=\"15\"><font size=\"2\">Item</font></td><td  align=\"right\"  width=\"5\"><font size=\"2\">Qty</font></td><td align=\"right\" width=\"8\"><font size=\"2\">Rate</font></td><td width=\"12\" align=\"right\" ><font size=\"2\">Amt</font></td></tr>");
            w.document.write("<tr><td colspan=\"4\">------------------------------------------</td></tr>");

            //method to collect data from gridview.
            var table = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>');
            //w.print();
            var PGrid = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>');
            var rowcount = (PGrid.rows.length) - 1;
            var CellValue, cell, tj;
            var i = 0
            //            w.document.write("<br>");
            while (i < rowcount) {

                cell = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>').rows[parseInt(i) + 1].cells[1];
                tj = cell.firstChild.innerHTML;
                //tj = table.innerHTML;
                w.document.write("<tr><td   align=\"left\"  >&nbsp;<font size=\"2\"> " + tj + "</font></td>");
                cell = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>').rows[parseInt(i) + 1].cells[4];
                tj = cell.firstChild.innerHTML;
                //tj = table.innerHTML;
                w.document.write("<td   align=\"right\"  >&nbsp;<font size=\"2\">" + tj + "</font></td>");
                cell = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>').rows[parseInt(i) + 1].cells[9];
                tj = cell.firstChild.innerHTML;
                //tj = table.innerHTML;
                w.document.write("<td   align=\"right\"  >&nbsp;<font size=\"2\">" + tj + "</font></td>");
                cell = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>').rows[parseInt(i) + 1].cells[10];
                tj = cell.firstChild.innerHTML;
                //tj = table.innerHTML;
                w.document.write("<td   align=\"right\"  >&nbsp;<font size=\"2\">" + tj + "</font></td></tr>");
                i = i + 1
            }
            w.document.write("</table>");
            w.document.write(Line);
            w.document.write("<br>");
            var BillTotal = document.getElementById("<%=txtTotalAmount1.ClientID %>").value;
            w.document.write("Bill Total : " + parseFloat(BillTotal).toFixed(2));
            w.document.write("<br>");
            var txtNoItems = document.getElementById("<%=txtTotalDiscAmount.ClientID %>").value;
            w.document.write("Total Discount : " + txtNoItems);
            w.document.write("<br>");
            var finalamount = BillTotal - txtNoItems
            w.document.write("Final Amount : " + finalamount);
            w.document.write("<br>");
            //---- Addition detail for sales invoice
            //            var txtNoItems = document.getElementById("<%=txtNoItems.ClientID %>").value;
            //            w.document.write("Total Items : " + parseFloat(txtNoItems).toFixed(2));
            //            w.document.write("<br>");
            //            var txtTotalQtyPOS = document.getElementById("<%=txtTotalQtyPOS.ClientID %>").value;
            //            w.document.write("Total Qty : " +  parseFloat( txtTotalQtyPOS).toFixed(2));
            //            w.document.write("<br>");
            //            var txtRound = Math.round(BillTotal) - BillTotal;
            //            w.document.write("Round Off Amt : " + parseFloat( txtRound).toFixed(2));
            //            w.document.write("<br>");
            //            w.document.write("Net Amt : " + parseFloat(Math.round(BillTotal)).toFixed(2));
            //            w.document.write("<br>");
            //            w.document.write("Cash Recd : " + parseFloat(document.getElementById("<%=txtcashRecv.ClientID %>").value).toFixed(2));
            //            w.document.write("<br>");
            //            w.document.write("Balance Paid : " + parseFloat(document.getElementById("<%=txtBalCash.ClientID %>").value).toFixed(2));
            //            w.document.write("<br>");
            //            w.document.write(Line);
            //            w.document.write("<br>");
            //            w.document.write("Tax Detail ");
            //            w.document.write("<br>");
            //            var TaxAmount = '<%= Session("TAXAmount") %>';
            //            
            //            w.document.write("VAT/ Tax Amt  : " + parseFloat(TaxAmount).toFixed(2) );
            //            w.document.write("<br>");
            //            w.document.write(Line);
            //            w.document.write("<br>");
            //            
            //           w.document.write("Total :" +  parseFloat(BillTotal + TaxAmount).toFixed(2));
            w.document.write("<br>");

            //             cell = document.getElementById('<%=GVSaleInvoiceDetails.ClientID %>').rows[parseInt(1) + 1].cells[1];
            //             tj = cell.firstChild.innerHTML;
            //          
            //             w.document.write(tj);

            // alert(tj);
//            var b = "<script language='javascript'>\nsub ClearWindow()\n{ document.body.innerHTML = ''; \n}</" + "script>";
//            w.document.write(b);
            var a = "<head> <script language='VBScript'>\nsub Print()\nOLECMDID_PRINT = 6\nOLECMDEXECOPT_DONTPROMPTUSER = 2\nEXECOPT_PROMPTUSER = 1\ncall WB.ExecWB(OLECMDID_PRINT, OLECMDEXECOPT_DONTPROMPTUSER,1)\nEnd Sub\n</" + "script></head>";

            w.document.write(a);
            w.document.write("<object id='WB' width='0' height='0' classid='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'></object>");
            w.document.write("<br>");
            w.document.write("<object id='WebBrowser1' width='0' height='0' classid='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'> </object>");


            //w.document.write(" <a href='#' onclick='Print()'>Click Here to Print</a> ");     
            w.document.write("<br>");
            w.document.write("<script>Print()<" + "/script>");
            //           w.window.close();
//            w.document.write("<script>ClearWindow()<" + "/script>");

            w.blur();
            w.window.location = "about:blank";
        ...
        <ContentTemplate>
            <a name="Top">
                ...
                <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" CssClass="ajax__tab_xp"
                    BackColor="#E2E3BB">
                    <ajaxToolkit:TabPanel ID="TabPanel3" runat="server" HeaderText="INVOICE DETAILS">
                        <ContentTemplate>
                            <center>
                                <h1 class="headingTxt">
                                    INVOICE DETAILS
                            ...
                            <table class="custTable">
                                <tr>
                                    <td>
                                        &nbsp;
                                        <asp:Button ID="btnAddMain" runat="server" Text="NEW INVOICE (Alt+N)" CssClass="ButtonClass "
                                            CausesValidation="true" Width="160px" SkinID="btnRsz" AccessKey="n" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label8" runat="server" Width="160px" SkinID="lblRsz" Text="Sale Invoice No.^*&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSaleInvoiceNO" runat="server" SkinID="txt"></asp:TextBox>
                                        <asp:HiddenField ID="HidSaleInvoiceNo" runat="server" />
                                        <asp:HiddenField ID="HidInvD" runat="server" />
                                    </td>
                                    <td align="right">
                                        <asp:Label ID="lblInvoiceDateDetails" Width="130px" runat="server" SkinID="lblRsz"
                                            Text="Invoice Date*&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtInvoiceDate" runat="server" SkinID="txt" MaxLength="11"></asp:TextBox>
                                        ...
                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" Animated="False"
                                            Format="dd-MMM-yyyy" TargetControlID="txtInvoiceDate" Enabled="True">
                                        </ajaxToolkit:CalendarExtender>
                                    </td>
                                </tr>
                                <tr align="right">
                                    <td>
                                        <asp:Label ID="Label11" runat="server" SkinID="lblRsz" Text="Selected by&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td colspan="2" align="left">
                                        <asp:RadioButtonList ID="RBProduct" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                                            SkinID="Themes">
                                            <asp:ListItem Selected="True" Text="Name" Value="1"></asp:ListItem>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnProduct" Visible="false" runat="server" Text="CODE " CssClass="ButtonClass "
                            ...
                            <center>
                                <table border="1">
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="lblItemDesc" runat="server" SkinID="lblRsz" Text="Item"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:Label ID="Label1" runat="server" SkinID="lblRsz" Text="Batch"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:Label ID="lblTotalQty" runat="server" Text="Total Qty" SkinID="lblRsz"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:Label ID="lblMRP" SkinID="lblRsz" runat="server" Text="MRP"></asp:Label>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            <asp:TextBox ID="txtProduct" runat="server" onfocus="this.select()"  AutoPostBack="true"
                                                SkinID="txt" AccessKey="i"></asp:TextBox>
                                            <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" runat="Server" CompletionInterval="500"
                                                EnableCaching="true" FirstRowSelected="true" MinimumPrefixLength="3" OnClientPopulated="HideImage"
                                                OnClientPopulating="ShowImage" ServiceMethod="getProductName" CompletionListCssClass="completeListStyle1"
                                                ServicePath="TextBoxExt.asmx" OnClientItemSelected="Splitter" TargetControlID="txtProduct">
                                            </ajaxToolkit:AutoCompleteExtender>
                                            <ajaxToolkit:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server"
                                                SkinID="watermark" TargetControlID="txtProduct" WatermarkText="Type first 3 characters">
                                            </ajaxToolkit:TextBoxWatermarkExtender>
                                        </td>
                                        </td>
                                        <td align="left">
                                            <asp:DropDownList ID="DDLBatch" SkinID="ddl" runat="server"  onkeypress="return keyBatchQty();" AutoPostBack="true" DataValueField="BatchAutoNo"
                                                DataTextField="batch">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtTotalQty1" Style="text-align: right" runat="server" SkinID="txtRsz"
                                                Width="80px" AccessKey="q" onkeypress="return KeyPressbutton();"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server"
                                                FilterMode="ValidChars" FilterType="Custom" ValidChars="0123456789." TargetControlID="txtTotalQty1">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtMRP" SkinID="txtRsz" Width="55px" Style="text-align: right" runat="server"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender9" runat="server"
                                                FilterMode="ValidChars" FilterType="Custom" ValidChars="0123456789." TargetControlID="txtMRP">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </td>
                                        <td align="left" style="width: 80px">
                                            <asp:TextBox ID="txtDeal" runat="server" Style="text-align: right" SkinID="txtRsz"
                                                Width="25px"></asp:TextBox>+<asp:TextBox ID="txtDeal1" runat="server" Style="text-align: right"
                                                    SkinID="txtRsz" Width="25px"></asp:TextBox>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDiscount" SkinID="txtRsz" Width="90px" Style="text-align: right"
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDiscountAmt" SkinID="txtRsz" Width="55px" Style="text-align: right"
                                                runat="server"></asp:TextBox>
                                ...
                                <table id="DetailsHide" runat="server">
                                    <tr>
                                        <td align="right">
                                            <asp:Label ID="lblQtyStock" runat="server" SkinID="lblRsz" Text="Product Qty :&nbsp;&nbsp;"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtProductQty" runat="server" Style="text-align: right" SkinID="txt"
                                                Enabled="false"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            <asp:Label ID="lblBatchQty" runat="server" SkinID="lblRsz" Text="Batch Qty :&nbsp;&nbsp;"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtBatchQty" runat="server" Style="text-align: right" SkinID="txt"
                                                Enabled="false"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                ...
                                <table id="TAXTable" runat="server">
                                    <tr>
                                        <td align="right">
                                ...
                                <table id="DetailsHide1" runat="server">
                                    <tr>
                                        <td align="right">
                                ...
                                <table>
                                    <tr>
                                        <td colspan="5" class="btnTd">
                                            <asp:Button ID="btnAddSaleInvoiceDetails" runat="server"   Width="150px" Text="ADD" CssClass="ButtonClass "
                                                CausesValidation="true" SkinID="btnRsz" OnClientClick="return Validate1();" AccessKey="a" />
                                            <asp:Button ID="btnViewSaleInvoiceDetails" runat="server" Width="150px" Text="VIEW" CausesValidation="False"
                                                SkinID="btnRsz" CssClass="ButtonClass" AccessKey="v" />
                                            <asp:Button ID="btnPrint" runat="server" Text="PRINT" Width="150px" CausesValidation="False" SkinID="btnRsz"
                                                CssClass="ButtonClass" OnClientClick="PrintInvoice();" AccessKey="p" />
                                            <asp:Button ID="BtnClose" runat="server" Text="CANCEL" Width="150px" CssClass="ButtonClass " CausesValidation="true"
                                                SkinID="btnRsz" AccessKey="c" />
                                        </td>
                                    </tr>
                                </table>
                            </center>
                            ...
                            <table align="center">
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label14" runat="server" SkinID="lblRsz" Text="Total Quantity&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTotalQtyPOS" Style="text-align: right" runat="server" SkinID="txt"
                                            Enabled="false"></asp:TextBox>
                                    </td>
                                    <td align="right">
                                        <asp:Label ID="Label12" runat="server" SkinID="lblRsz" Text="Total Amount&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTotalAmount1" Style="text-align: right" runat="server" SkinID="txt"
                                            Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label13" runat="server" SkinID="lblRsz" Text="Total Discount Amt&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTotalDiscAmount" Style="text-align: right" runat="server" SkinID="txt"
                                            Enabled="false"></asp:TextBox>
                                    </td>
                                    <td align="right">
                                        <asp:Label ID="Label15" runat="server" SkinID="lblRsz" Text="No of Items&nbsp;:&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtNoItems" Style="text-align: right" runat="server" SkinID="txt"
                                            Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label16" runat="server" SkinID="lblRsz" Text="Cash :&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtcashRecv" runat="server" Style="text-align: right" SkinID="txt"></asp:TextBox>
                                    </td>
                                    <td align="right">
                                        <asp:Label ID="Label17" runat="server" SkinID="lblRsz" Text="Balance :&nbsp;&nbsp;"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox ID="txtBalCash" runat="server" Style="text-align: right" SkinID="txt"
                                            Enabled="false"></asp:TextBox>
                                    </td>
                                    <td align="left">
                                        <asp:Button ID="BtnCheck" SkinID="btnRsz" Text="Check" runat="server" />
                                    </td>
                                </tr>
                            </table>
                            <br />
                            <center>
                                <asp:Panel ID="panel3" runat="server" ScrollBars="Auto" Width="700px" Height="300px">
                                    <asp:GridView ID="GVSaleInvoiceDetails" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                        PageSize="100" SkinID="GridView" Width="500px" align="center">
                                        <Columns>
                                            <asp:TemplateField InsertVisible="False" ShowHeader="False">
                                                <ItemTemplate>
                                                    <center>
                                                        <asp:LinkButton ID="LkSaliInvoiceEdit" runat="server" CausesValidation="False" CommandName="Edit"
                                                            Text="Edit" />
                                                        <asp:LinkButton ID="LkSaliInvoiceDelete" runat="server" CausesValidation="False"
                                            ...
                                            <asp:TemplateField HeaderText="Batch">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblBatchID" runat="server" Visible="false" Text='<%#bind("Batch_ID")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" />
                                                <HeaderStyle Wrap="false" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Sale Rate">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTradeRate" runat="server" Text='<%# Bind("Sale_Rate","{0:n2}") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAmount" runat="server" Text='<%# Bind("Sale_Amount","{0:n2}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField Visible="false" HeaderText="Margin">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblMargin" runat="server" Text='<%# Bind("Margin","{0:n2}") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Final Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotFinalAmt" runat="server" Text='<%# Bind("Sale_Final_Amount","{0:n2}") %>'></asp:Label>
                                                    <asp:Label ID="Label18" Visible="false" runat="server" Text='<%# Bind("EntryDate")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Wrap="false" HorizontalAlign="Right" />
                                            </asp:TemplateField>
                                        </Columns>
                    ...
                    <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="SALE INVOICE REGISTER">
                        <ContentTemplate>
                            <center>
                                <h1 class="headingTxt">
                                    SALE INVOICE
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:HiddenField ID="HIDConversion" runat="Server" Visible="false" />
                                    </td>
                                </tr>
                            </table>
                            <center>
                                ...
                                <table id="otherdetails" runat="server">
                                    <tr>
                                        <td>
                                            <b>OTHER DETAILS </b>
                                        </td>
