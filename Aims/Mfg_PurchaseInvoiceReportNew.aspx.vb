...
Partial Class Mfg_PurchaseInvoiceReportNew
    Inherits BasePage
    ''Created By -->Anchala Verma
    ''Date-->11-Dec-2013
    Protected Sub Btnreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnreport.Click
        ...
        Try
            ...
            Dim qrystring As String = "Mfg_RptPurchaseInvoiceNewV.aspx?" & QueryStr.Querystring() & "&Supp_ID=" & Supp_ID & "&PI_ID=" & PI_ID & "&StartDate=" & StartDate & "&EndDAte=" & EndDAte
