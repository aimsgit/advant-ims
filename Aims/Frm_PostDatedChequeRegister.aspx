<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Frm_PostDatedChequeRegister.aspx.vb" Inherits="Frm_PostDatedChequeRegister" title="Post Dated Cheque Register" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Post Dated Cheque Register</title>
                        ...
                        <table>
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <asp:ObjectDataSource ID="ObjBank" runat="server" SelectMethod="Get_BankName"
                                     TypeName="PostDatedChequeRegister">
