...
Partial Class RPTBalanceSheet
    ...
    Protected Sub Btnreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnreport.Click
        If Session("Privilages").ToString.Contains("W") Or Session("Privilages").ToString.Contains("R") Then
            ...
            Try
                ...
                Dim qrystring As String = "BalanceSheetV.aspx?" & QueryStr.Querystring() & "&FinStartDate=" & CDate(txtStartDate.Text) & "&FinEndDate=" & CDate(txtEndDate.Text)
    ...
    Protected Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            lblSumAsset.Visible = False
            lblSumLia.Visible = False
        End If
    End Sub
    ...
    Sub DisplayGridView()
        ...
        If dt.Rows.Count > 0 Then
            ...
            Next
            lblGrandTotal.Visible = True
            lblSumAsset.Visible = True
            lblSumLia.Visible = True
