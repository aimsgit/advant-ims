...
Partial Class RptFeedBackV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = dl.FeedBackReport(BatchId, SemId, EmpId)
        ...
        Try
            If dt1.Rows.Count > 0 Then
                ...
                Me.ReportViewer1.LocalReport.ReportPath = "RptFeedBack.rdlc"
                dt = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_FeedBackReport", dt1)
