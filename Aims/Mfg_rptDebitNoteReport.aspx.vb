...
Partial Class Mfg_rptDebitNoteReport
    Inherits BasePage
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Try
            ...
            Dim qrystring As String = "Mfg_rptDebitNoteV.aspx?" & QueryStr.Querystring() & "&SupplierId=" & SupplierId & "&InvoiceNo=" & InvoiceNo & "&StartDate=" & fromdate & "&EndDate=" & enddate
