...
Partial Class frmAssetDynamicReport
    Inherits BasePage
    ...
    Protected Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            dt = BL.AssetDetailsDynamicReport()
    ...
    Protected Sub btnAdmission_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdmission.Click
        ...
        If id <> "" Then
            ...
            Dim qrystring As String = "RptAssetDynamicreport.aspx?" & QueryStr.Querystring() & "&id=" & id & "&Type=" & ddlassetType.SelectedValue & "&Supplier=" & ddlsupplier.SelectedValue & "&Manufacturer=" & ddlmanufacturer.SelectedValue
