<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptTransferCertificate.aspx.vb"
    Inherits="RptTransferCertificate" Title="Transfer Certificate" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div>
                    <center>
                        <h1 class="headingTxt">
                            <asp:Label ID="Labeltc" runat="server" Text="TRANSFER CERTIFICATE"
                                SkinID="lblRepRsz" Width="290" Visible="True"></asp:Label></h1>
                    </center>
                    <br />
                    <center>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlStudent" runat="server" SkinID="ddlRsz" DataSourceID="ObjStudent"
                                        ...
                                        Width="200" AutoPostBack="true" TabIndex="6">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <%-- <tr>
