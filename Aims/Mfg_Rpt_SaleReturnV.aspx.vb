...
Partial Class Mfg_Rpt_SaleReturnV
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        dt1 = Mfg_DLSaleReturn.GetSaleReturn(BuyerId, SaleReturnId, StartDate, EndDate)

        If dt1.Rows.Count > 0 Then
            Try
                ReportViewer1.LocalReport.ReportPath = "Mfg_Rpt_SaleReturn2.rdlc"
                dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_SaleReturn_Report", dt1)
