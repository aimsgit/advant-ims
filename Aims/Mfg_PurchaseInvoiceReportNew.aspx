<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mfg_PurchaseInvoiceReportNew.aspx.vb"
    Inherits="Mfg_PurchaseInvoiceReportNew" Title="Purchase Invoice" %>
    ...
    <center>
        ...
        <table>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList ID="cmbPurInv" runat="server" DataTextField="Purchase_Invoice_No"
                        SkinID="ddl" DataSourceID="ObjectDataSource2" DataValueField="PurchMain"
                        TabIndex="2">
                    </asp:DropDownList>
