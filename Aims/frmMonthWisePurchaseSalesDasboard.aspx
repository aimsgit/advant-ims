<%@ Page Title="" Language="VB" AutoEventWireup="false" CodeFile="frmMonthWisePurchaseSalesDasboard.aspx.vb" Inherits="frmMonthWisePurchaseSalesDasboard"%>
    ...
    <asp:UpdatePanel ID="UP1" runat="server">
        <ContentTemplate>
            <center>
                <br />
                <h1 class="headingTxt">
                    MONTHWISE PURCHASE SALES STATUS
                </h1>
                <br />
            </center>
            <center>
