...
Partial Class Rpt_RemitenanceListNewV
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Dim Item As Integer = Request.QueryString.Get("Item")
        Dim Payment As String = Request.QueryString.Get("Payment")
        Dim BankId As String = Request.QueryString.Get("BankId")
        Dim itemName As String = Request.QueryString.Get("ItemName")
        QueryStr.GetValue(Page.Request, Prop)

        dt1 = DLAnnualSalaryStatment.RptRemitenanceListNew(Year, Month, Item, itemName, Payment, BankId)
        Try
            If dt1.Rows.Count > 0 Then

                Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
                Me.ReportViewer1.LocalReport.ReportPath = "Rpt_RemitenanceListNew.rdlc"

                dt = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_RemitenanceListNew", dt1)
