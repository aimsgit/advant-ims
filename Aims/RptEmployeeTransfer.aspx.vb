...
Partial Class RptEmployeeTransfer
    Inherits BasePage
    Protected Sub btnTReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTReport.Click
        ...
        If fromdateE > todateE Then
            ...
            Exit Sub
        End If
        Dim qrystring As String = "RptEmployeeTransferV.aspx?" & QueryStr.Querystring() & "&StartDate=" & fromdateE & "&EndDate=" & todateE & "&BranchCode=" & BranchCode
