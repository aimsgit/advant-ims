...
Partial Class Mfg_RptAccountsPayable
    Inherits BasePage
    Protected Sub Btnreport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Btnreport.Click
        Try
            ...
            Dim qrystring As String = ConfigurationManager.AppSettings("ReportPath") & "Mfg_Rpt_AccountsPayableV.aspx?" & QueryStr.Querystring() & qry_str
