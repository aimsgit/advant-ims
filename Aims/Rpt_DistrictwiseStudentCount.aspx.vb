...
Partial Class Rpt_DistrictwiseStudentCount
    Inherits BasePage
    ...
    Protected Sub BtnGReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnGReport.Click
        ...
        If fromdateE > todateE Then
            ...
            Exit Sub
        End If
        Dim qrystring As String = "Rpt_DistrictwiseStudentCountGraphV.aspx?" & QueryStr.Querystring() & "&StartDate=" & fromdateE & "&EndDate=" & todateE & "&BranchCode=" & BranchCode & "&BranchCode1=" & BranchCode1
