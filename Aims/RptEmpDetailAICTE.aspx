<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RptEmpDetailAICTE.aspx.vb" Inherits="RptEmpDetailAICTE" title="Employee Details - AICTE Format" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Employee Details - AICTE Format</title>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:ObjectDataSource ID="ObjDept" runat="server" TypeName="DLFacutlyDevelopment"
                                SelectMethod="GetDeptTypeAllAICTE"></asp:ObjectDataSource>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            ...
                            <asp:ObjectDataSource ID="odsDesig" runat="server" SelectMethod="DesignationAICTE" TypeName="EmpTransD">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:ObjectDataSource ID="objGrade" runat="server" SelectMethod="GetGradeAICTE" TypeName="EmpTransD">
                            </asp:ObjectDataSource>
                        </td>
                    </tr>
                    <%--<tr>
