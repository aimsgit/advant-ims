...
Imports System.IO
'07-Sep-2012. Kusum C Akki. Dynamic report data binding
Partial Class RptDynamicReport
    Inherits BasePage
    ...
    Private Sub CreateDynamicTable()
        ...
        Dim CountryId As Integer = Request.QueryString.Get("CountryId")
        Dim Feecollected As String = Request.QueryString.Get("Feecollected")
        dt = bl.AdmissionRegisterDynamic(Branch, Course, Batch, Gender, State, Feecollected, ID, CountryId)
