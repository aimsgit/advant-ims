Partial Class RptStudentAttendanceDetails
    Inherits BasePage
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
        ...
        Try
            ...
            ElseIf Session("LoginType") = "Others" Then
                ...
                Max = 1000
                SortBy = Request.QueryString.Get("SortBy")
                categ = ParentDt.Rows(0).Item("categoryid").ToString
            End If

            QueryStr.GetValue(Page.Request, Prop)
            dt1 = Dl.GetStudentReport(Bat, Sem, Subj, CT, StdId, fromdate, todate, Min, Max, SortBy, categ)
            Try
                If dt1.Rows.Count > 0 Then
                    ReportViewer1.LocalReport.ReportPath = "RptStudentAttendanceDetails.rdlc"
                    dm = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Rpt_StudentAttendanceRpt", dt1)
