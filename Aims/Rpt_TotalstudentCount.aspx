<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Rpt_TotalstudentCount.aspx.vb"
    Inherits="Rpt_TotalstudentCount" Title="TOTAL STUDENT COUNT DASHBOARD" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TOTAL STUDENT COUNT DASHBOARD</title>
                        ...
                        <tr>
                            ...
                            <td align="Left">
                                &nbsp<asp:DropDownList ID="ddlBranchName" TabIndex="1" runat="server" SkinID="ddlRsz"
                                    Width="350px" AutoPostBack="True" DataSourceID="ObjBranch" DataTextField="BranchName"
                                    DataValueField="BranchCode">
                                </asp:DropDownList>
                                <asp:ObjectDataSource ID="ObjBranch" runat="server" OldValuesParameterFormatString="original_{0}"
                                    SelectMethod="insertBranchCombo" TypeName="TotalStudentCount"></asp:ObjectDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
