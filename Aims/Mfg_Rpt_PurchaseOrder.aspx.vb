...
Partial Class Mfg_Rpt_PurchaseOrder
    ...
    Protected Sub ReportViewer1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ReportViewer1.Init
      Dim id As String = Request.QueryString.Get("id")
        ...
        Try
            ...
            dt1 = DL.GetPurchaseOrder2(id)
            If dt1.Rows.Count > 0 Then
                Try

                    ReportViewer1.LocalReport.ReportPath = "Mfg_Rpt_PurchaseOrder.rdlc"
                    dr1 = New Microsoft.Reporting.WebForms.ReportDataSource("GlobalDataSet_Mfg_GetPurchaseOrder", dt1)
