...
Partial Class frmStudentAttendance
    ...
    Dim StudentPerformanceDL As New StudentPerformanceDL
                    ...
                    Else
                        ...
                        Else
                            ...
                            If dt2.Rows.Count > 0 Then
                                ...
                                If dt2.Rows(0).Item("Config_Value") > TotRemDays Then
                                ...
                                Else
                                    msginfo.Text = "Attendance entry not allowed after " + dt2.Rows(0).Item("Config_Value") + " days from Today\s'date"
            ...
            Else
                ...
                For Each grid As GridViewRow In GVStdAttd.Rows
                    If CType(grid.FindControl("ChkPresent"), CheckBox).Checked = True Then
                        ...
                        Bl.UpdateRecord(El)
                        dt2 = dl.GetAttendenceConfiguration
                        If dt2.Rows.Count > 0 Then
                            'ScriptManager.RegisterStartupScript(Me, Me.GetType(), "UpdateItem", "UpdateItem();", True)
                            '    Dim result As Windows.Forms.DialogResult = Windows.Forms.MessageBox.Show("Some text", "Some caption", Windows.Forms.MessageBoxButtons.OKCancel)
            ...
            Try
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    For i As Integer = 0 To dt.Rows.Count - 1
                        ViewState("ConcatID") = ViewState("ConcatID") + "," + dt.Rows(i).Item("Id").ToString
                    Next
                    'dt2 = dl.GetAttendenceConfigurationRoll
                    'If dt.Rows.Count > 0 Then
                    '    If dt2.Rows(0).Item("Config_Value") = "Role" Then
                    ...
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "", "document.getElementById('" + ExportPanel.ClientID + "').style.visibility='hidden';", True)
                    'Else
                    '    lblmsg.Text = "Please inter password"
                    '    Exit Sub
                    'End If


                    '    Else
                    'lblmsg.Text = "User Role Doesnot found"
                    '    End If
                        Else
        'Clear()
        msginfo.Text = ValidationMessage(1211)
    ...
    Protected Sub BtnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExport.Click
        ...
        GVStdAttd.Parent.Controls.Add(frm)
    ...
    Sub ViewDataStatus()
        Try
            ...
            Dim qrystring As String = "RptStdAttenDataStatusV.aspx?" & QueryStr.Querystring() & "&Batch=" & El.Batch
    ...
    Protected Sub RptButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RptButton.Click
        Try
            ...
            El.SubGrp = ddlSubjectSubGrp.SelectedValue
            AssignEntity()
            Dim qrystring As String = "RptStudAtten.aspx?" & "&Ayear=" & El.Academic & "&Batch=" & El.Batch & "&Semester=" & El.SemesterId & "&Subject=" & El.SubjectId & "&AttenDate=" & El.AttendanceDate & "&SubGrp=" & El.SubGrp & "&SessionCountDay=" & El.SessionCountDay
    ...
    Protected Sub btnLeave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLeave.Click
        Try
            If (Session("BranchCode") = Session("ParentBranch")) Then
                msginfo.Text = ""
                lblmsg.Text = ""
                'El.Batch = cmbBatch.SelectedValue
                'El.SemesterId = cmbSemester.SelectedValue
                dt1 = stdAttndance.MedicalLeave(cmbBatch.SelectedValue, cmbSemester.SelectedValue)
                msginfo.Text = "Medical Leave is Updated Sucessfully."
            Else
                msginfo.Text = ValidationMessage(1210)
                lblmsg.Text = ValidationMessage(1014)
            End If
        ...
        End Try
    End Sub
    Public Function UpdateLock() As String
        If dt2.Rows(0).Item("Config_Value") = "Auto" Then
    ...
    End Function
    Sub message()
        If System.Windows.Forms.MessageBox.Show("Are you sure to Lock the records.", "Title", System.Windows.Forms.MessageBoxButtons.OKCancel,
             Nothing, System.Windows.Forms.MessageBoxDefaultButton.Button1) = System.Windows.Forms.DialogResult.OK Then
