<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FrmEmpTransfer.aspx.vb"
    Inherits="FrmEmpTransfer" Title="Employee Transfer" ValidateRequest="false"%>
                    ...
                    <center>
                        <table class="custTable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtEmp" runat="server" SkinID="txt" Width="150px" TabIndex="1"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtEmpName" runat="server" Width="150px" SkinID="txt" AutoPostBack="true"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDOL" runat="server" SkinID="txt" Width="150px" MaxLength="11"
